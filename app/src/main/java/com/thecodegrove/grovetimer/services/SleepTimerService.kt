...
class SleepTimerService : Service() {
    ...
    private fun buildTimerNotification(remainingTime: Long, isPaused: Boolean): android.app.Notification {
        ...
        val contentIntent = Intent(this, com.thecodegrove.grovetimer.MainActivity::class.java).apply {
    ...
    companion object {
        ...
        const val ACTION_TIMER_FINISHED = "com.thecodegrove.grovetimer.TIMER_FINISHED"
        const val ACTION_TIMER_STOPPED = "com.thecodegrove.grovetimer.TIMER_STOPPED"
        const val ACTION_TIMER_PAUSED = "com.thecodegrove.grovetimer.TIMER_PAUSED"
        const val ACTION_TIMER_RESUMED = "com.thecodegrove.grovetimer.TIMER_RESUMED"
