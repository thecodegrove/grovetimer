...
import dev.thecodegrove.grovetimer.MainActivity
...
class TimerNotificationService : Service() {
    ...
    companion object {
        ...
        const val ACTION_PAUSE_TIMER = "dev.thecodegrove.grovetimer.ACTION_PAUSE_TIMER"
        const val ACTION_RESUME_TIMER = "dev.thecodegrove.grovetimer.ACTION_RESUME_TIMER"
        const val ACTION_STOP_TIMER = "dev.thecodegrove.grovetimer.ACTION_STOP_TIMER"
        const val ACTION_UPDATE_NOTIFICATION = "dev.thecodegrove.grovetimer.ACTION_UPDATE_NOTIFICATION"
        const val ACTION_START_NOTIFICATION = "dev.thecodegrove.grovetimer.ACTION_START_NOTIFICATION"
