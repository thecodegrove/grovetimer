package dev.thecodegrove.grovetimer
...
import dev.thecodegrove.grovetimer.ui.navigation.GroveTimerNavigation
import dev.thecodegrove.grovetimer.ui.theme.GroveTimerTheme
...
class MainActivity : ComponentActivity() {
    ...
    private fun checkRequiredPermissions() {
        ...
        if (!allRequiredPermissionsGranted || !notificationListenerEnabled) {
            val intent = Intent(this, dev.thecodegrove.grovetimer.ui.permissions.PermissionRequestActivity::class.java)
