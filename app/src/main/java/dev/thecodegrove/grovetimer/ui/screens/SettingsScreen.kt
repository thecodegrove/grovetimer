...
import dev.thecodegrove.grovetimer.ui.common.MaterialCard
...
fun SettingsScreen(
    ...
    val darkModeState by (timerViewModel?.settingsState?.collectAsState(initial = dev.thecodegrove.grovetimer.domain.model.UserSettings.DEFAULT) 
        ?: androidx.compose.runtime.mutableStateOf(dev.thecodegrove.grovetimer.domain.model.UserSettings.DEFAULT))
